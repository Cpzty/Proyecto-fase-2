...
public class Principal {
	...
	private void initialize() {
		...
		panel_1.setBounds(10, 203, 549, 179);
		...
		panel_1.add(lblIngreseLaCantidad);
		...
		panel_1.add(lblCalcularDineroAhorrado);
		...
		panel_1.add(lblSeleccioneLaDimensional);
        ...
        lblReciguate.setBounds(234, 11, 147, 14);
